...
function addArtist(array, id, name, years, nationality, genre, bio){
  array.push({id, name, years, genre, nationality, bio});
  return array;
}
console.log(addArtist(artists, 20, "Kevin", "1996 - now", "USA", "Web Development", "I'm an up and coming web developer from Michigan."));  
